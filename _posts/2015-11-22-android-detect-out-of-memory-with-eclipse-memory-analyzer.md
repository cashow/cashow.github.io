...
![mat_android_device_monitor](http://phe7e07bw.bkt.clouddn.com/mat_android_device_monitor.png)
2.在DDMS左侧选中应用包名，点击上方垃圾桶样式的“Cause GC”按钮，强制触发垃圾回收。  
![mat_ddms_cause_gc](http://phe7e07bw.bkt.clouddn.com/mat_ddms_cause_gc.png)
3.点击“Cause GC”按钮左边的“Dump HPROF file”按钮，弹出保存文件的对话框。
![mat_ddms_dump_hprof_file](http://phe7e07bw.bkt.clouddn.com/mat_ddms_dump_hprof_file.png)
![mat_ddms_save_hprof_file](http://phe7e07bw.bkt.clouddn.com/mat_ddms_save_hprof_file.png)
...
![mat_getting_started](http://phe7e07bw.bkt.clouddn.com/mat_getting_started.png)
第一个选项是自动分析可能存在内存泄露的对象。  
第二个选项是分析可疑对象，如字符串是否定义重了，空的collection、finalizer以及弱引用等。  
第三个选项是打开上次的报告。  
三个选项都不需要选中，把”Show this dialog ...“前面的勾去掉，点击cancel。  
点击右上角的Restore按钮：
![mat_restore](http://phe7e07bw.bkt.clouddn.com/mat_restore.png)
可以看到Overview界面，如下图所示：  
![mat_overview](http://phe7e07bw.bkt.clouddn.com/mat_overview.png)
...
![mat_histogram](http://phe7e07bw.bkt.clouddn.com/mat_histogram.png)
...
![mat_histogram_filtered](http://phe7e07bw.bkt.clouddn.com/mat_histogram_filtered.png)
...
![mat_shortest_path](http://phe7e07bw.bkt.clouddn.com/mat_shortest_path.png)
...
![mat_histogram_filtered_2](http://phe7e07bw.bkt.clouddn.com/mat_histogram_filtered_2.png)
...
![mat_domanitor_tree](http://phe7e07bw.bkt.clouddn.com/mat_domanitor_tree.png)
这个页面列出了占用内存较大的对象。  
...
![mat_bitmap_info](http://phe7e07bw.bkt.clouddn.com/mat_bitmap_info.png)
...
![mat_bitmap_byte](http://phe7e07bw.bkt.clouddn.com/mat_bitmap_byte.png)
![mat_save_bitmap](http://phe7e07bw.bkt.clouddn.com/mat_save_bitmap.png)
...
![gimp_gnu](http://phe7e07bw.bkt.clouddn.com/gimp_gnu.png)
出现以下对话框：  
![gimp_preview](http://phe7e07bw.bkt.clouddn.com/gimp_preview.png)
图像类型选择RGB Alpha，宽度和高度填上第一步获取到的图片宽度和高度，预览图会显示图片的一小部分
![gimp_preview_2](http://phe7e07bw.bkt.clouddn.com/gimp_preview_2.png)
点击open后可看到原图
![gimp_ori](http://phe7e07bw.bkt.clouddn.com/gimp_ori.png)
